...
#iptables -t mangle -A PREROUTING -p udp -s localhost -j RETURN
#iptables -t mangle -A PREROUTING -p udp -s 160.39.135.18 -j TPROXY --tproxy-mark 0x1/0x1 --on-port 7777
